...
public class AttractionAdapter extends ArrayAdapter<Attraction> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Get the Attractiontitle from the currentAttraction object and set this text on
        // the TextView.
        attractionTextView.setText(currentAttraction.getAttractionTitle());

        // Find the TextView in the list_item.xml layout with the ID default_text_view.
        TextView defaultTextView = (TextView) listItemView.findViewById(R.id.default_text_view);
        // Get the default translation from the currentAttraction object and set this text on
        // the default TextView.
        defaultTextView.setText(currentAttraction.getAttractionDescription());
